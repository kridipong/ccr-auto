        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href={`/${locale}`} className="flex items-center gap-3 shrink-0 group">
            ...
            <div className="flex items-baseline">
              <span className="text-xl font-bold tracking-wider glow-text" style={{ color: '#00d4ff' }}>
                CCR
              </span>
              <span className="text-sm font-bold ml-0.5 tracking-[0.2em]" style={{ color: '#ff3366', textShadow: '0 0 15px rgba(255,51,102,0.6)' }}>
                AUTO
              </span>
            </div>
          </Link>
            ...
            {[
              ...
              <Link
                ...
                onMouseOut={(e) => {
                  ...
                  e.currentTarget.style.textShadow = '0 0 5px rgba(0,212,255,0)';
                }}
              >
                {link.label}
              </Link>
            ...
            <div className="flex items-center gap-1 ml-3 px-3" style={{ borderLeft: '1px solid rgba(255,255,255,0.1)' }}>
              ...
              {locales.map((l) => (
                <button
                  ...
                  style={{
                    color: locale === l ? '#00d4ff' : 'rgba(255,255,255,0.5)',
                    background: locale === l ? 'rgba(0,212,255,0.15)' : 'transparent',
                    textShadow: locale === l ? '0 0 8px rgba(0,212,255,0.4)' : 'none',
                  }}
                >
                  {localeNames[l]}
                </button>
