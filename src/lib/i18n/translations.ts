...
export const en = {
  ...
  'admin.brands': 'Brands',
  'admin.brand_add': 'Add Brand',
  'admin.brand_edit': 'Edit Brand',
  'admin.brand_logo': 'Brand Logo',
  'brand.name_th': 'Brand Name (Thai)',
  'brand.name_en': 'Brand Name (English)',
  'brand.select': 'Select Brand',
  'brand.products': 'Products from {brand}',
  'brand.browse': 'Browse by Brand',
...
export const th: Record<TranslationKey, string> = {
  ...
  'admin.brands': 'แบรนด์',
  'admin.brand_add': 'เพิ่มแบรนด์',
  'admin.brand_edit': 'แก้ไขแบรนด์',
  'admin.brand_logo': 'โลโก้แบรนด์',
  'brand.name_th': 'ชื่อแบรนด์ (ภาษาไทย)',
  'brand.name_en': 'ชื่อแบรนด์ (ภาษาอังกฤษ)',
  'brand.select': 'เลือกแบรนด์',
  'brand.products': 'สินค้าจาก {brand}',
  'brand.browse': 'เลือกตามแบรนด์',
